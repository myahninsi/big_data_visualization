...
import os
from predictor import predict_prices,determine_model,data_files_names,zipcode_detail
...
def predict_price():
    ...
    return render_template("model.html",predictions=True,predicted_price=predicted_price,r2=r2,rmse=rmse,mlr_name=mlr_name)

#not in use - maybe eliminated for the last presentation
